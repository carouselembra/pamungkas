        	...
        	<div class="col-12 table-responsive">
              ...
              <thead>
                <tr>
                  ...
                  <th class="text-center b-left">Penilaian</th>
                  <th class="text-center b-left">Struktur & Proses</th>
                  <th class="text-center b-left">Pencapaian Tujuan</th>
                </tr>
              </thead>
              <tbody>
                @foreach($access as $user)
                  ...
                  <td class="text-center b-left" data-access="penilaian" data-user="{{ $user->user }}" data-role="{{ $user->role }}">
                    @if($user->penilaian == 1)
                    <div class="btn-checkbox btn-access">
                        <i class="mdi mdi-checkbox-marked"></i>
                    </div>
                  ...
                  <td class="text-center b-left" data-access="struktur_proses" data-user="{{ $user->user }}" data-role="{{ $user->role }}">
                    @if($user->struktur_proses == 1)
                    <div class="btn-checkbox btn-access">
                        <i class="mdi mdi-checkbox-marked"></i>
                    </div>
                    @else
                  ...
                  <td class="text-center b-left" data-access="pencapaian_tujuan" data-user="{{ $user->user }}" data-role="{{ $user->role }}">
                    @if($user->pencapaian_tujuan == 1)
                    <div class="btn-checkbox btn-access">
                        <i class="mdi mdi-checkbox-marked"></i>
                    </div>
                    @else
