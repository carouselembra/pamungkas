    ...
    <div class="page-header d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex justify-content-start">
      	<div class="dropdown">
            ...
            <a href="#" class="dropdown-item filter-btn" data-filter="role">Role</a>
	        </div>
	      </div>
      ...
      <div class="modal-content">
        <form action="{{ url('/account/update') }}" method="post" enctype="multipart/form-data" name="update_form">
          ...
          <div class="modal-body">
              ...
              <div class="form-group row">
                <label class="col-3 col-form-label font-weight-bold">Satker</label>
                <div class="col-9">
  ...
  $(document).on('click', '.btn-edit', function(){
    ...
    $.ajax({
      ...
      success:function(response)
      {
        ...
        $('select[name=satker] option[value="'+ response.user.id_satker +'"]').prop('selected', true);
        validator.resetForm();
      }
    });
  });
