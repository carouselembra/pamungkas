...
class SearchManageController extends Controller
{
    ...
    public function searchPage($word)
    {
    	...
    	foreach ($access as $acces) {
    		$access_content .= ' (Nama : ' . $acces->nama . ', Kelola Akun : ' . $acces->kelola_akun . ', Kelola Barang : ' . $acces->penilaian . ', Transaksi : ' . $acces->transaksi . ', Kelola Laporan : ' . $acces->kelola_laporan . ')';
    	}
    	// Product
